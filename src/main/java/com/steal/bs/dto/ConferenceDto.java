...
public class ConferenceDto {
	...
	public ConferenceDto(int num, String name, String pwd, int totalcount, int remaincount, String master, String user1,
	...
	public String toString() {
		return "ConferenceDto [num=" + num + ", name=" + name + ", pwd=" + pwd + ", totalcount=" + totalcount
